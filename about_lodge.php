            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 lg:p-10">
                    <div class="single_about_info col-lg-8 m-auto">
                        ...
                        <ul>
                            <li>
                                🥥  Piscine, babyfoot, jeux de société
                            </li>
                            <li>
                                🥥  Cuisine commune équipée, eau chaude    
                            </li>
                            <li>
                                🥥  Wifi, canal+ 
                            </li>
                            <li>
                                🥥  Grand parking sécurisé et clôturé 
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="single_about_info col-lg-8 m-auto">
                        ...
                        <ul>
                            ...
                            <li>🥥  Présentation CIN et passeport.</li>
                            <li>🥥  Réservation : accompte 50% des nuitées. </li>
                            <li>🥥  Paiement: Mvola ou espèces.</li>
                        </ul>
                    </div>
                </div>
            </div>
